...
// ─────────────────────────────────────────────
// Khởi tạo HTTP hoặc HTTPS server
// ─────────────────────────────────────────────
let server;
...
if (fs.existsSync(certPath) && fs.existsSync(keyPath)) {
  ...
  // Chưa có cert → dùng HTTP + WS (phù hợp khi dev localhost)
 ...
 * excludeName: bỏ qua người này (thường là sender).
 */
...
/**
 * Gửi roomMembers (danh sách thành viên hiện tại) cho tất cả trong phòng.
 */
